...
namespace QuizAPI.Controllers
{
    ...
    public class ParticipantController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutParticipant(int id, ParticipantResult _participanResult)
        {
            if (id != _participanResult.ParticipantID)
            {
                return BadRequest();
            }

            Participant participant = _context.Participants.Find(id);
            participant.Score = _participanResult.Score;
            participant.TimeTaken = _participanResult.TimeTaken;
